...
def build_instructor_prompt(*, current: str, previous_msgs: str, student_q: str, plan: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "2. Airway abbreviations such as RB2, LB4, RMB, and BI are allowed when they help the student follow the route.\n"
        ...
        "GOOD EXAMPLES:\n"
        "- Back out just a touch. RB2 should come up on your right.\n"
        "- You're at RMB. Continue toward RB7.\n"
        "- Good, you've reached RB2. RB3 should come up on your left.\n"
        ...
        "1a. Please teach student how to move the knob, rotate or translate the bronchoscope accordingly.\n"
        "2. Follow the target airway exactly.\n"
        "3. Keep the clinical intent of the plan, but rewrite it as natural bedside speech.\n"
        "3a. For local sibling moves, prefer short visual finding cues such as left, right, upper, lower, medial, lateral, forward, or back.\n"
        "3b. If the student has reached a waypoint, acknowledge it briefly without praise and continue toward the training target.\n"
...
def build_runtime_instructor_prompt(*, current: str, previous_msgs: str, student_q: str, plan: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "2. Keep the clinical intent of the plan, but do not copy internal landmark IDs into the final answer.\n"
        "3. Do not use exact engineering angles in the spoken guidance.\n"
        "4. Airway abbreviations such as RB2, LB4, RMB, and BI are allowed when they help the student follow the route.\n"
        ...
        "- Ease the tip up slightly. Keep the lumen centered.\n"
        "- You're at RMB. Continue toward RB7.\n"
        "- Hold center. Find the next opening.\n\n"
        "AVOID THESE STYLES:\n"
        "- L2_RUL\n"
        "- 90 degrees right\n"
